...
func apply_primary_style():
	...
	style_focus.bg_color = style_constants.COLOR_ACCENT_GREEN
	style_focus.border_color = style_constants.COLOR_ACCENT_PINK
	...
	style_focus.border_width_left = style_constants.FOCUS_BORDER_WIDTH
	style_focus.border_width_right = style_constants.FOCUS_BORDER_WIDTH
	style_focus.border_width_top = style_constants.FOCUS_BORDER_WIDTH
	style_focus.border_width_bottom = style_constants.FOCUS_BORDER_WIDTH
	style_focus.set_corner_radius_all(style_constants.RADIUS_BUTTON)
...
func apply_secondary_style():
	...
	var style_pressed = StyleBoxFlat.new()
	style_pressed.bg_color = Color(style_constants.COLOR_ACCENT_GREEN.r, style_constants.COLOR_ACCENT_GREEN.g, style_constants.COLOR_ACCENT_GREEN.b, 0.3)
	style_pressed.border_color = style_constants.COLOR_ACCENT_GREEN
...
func _on_pressed():
	...
	tween.tween_property(self, "scale", Vector2(0.95, 0.95), style_constants.ANIM_QUICK)
	...
	tween.set_trans(Tween.TRANS_BACK)
	tween.set_ease(Tween.EASE_OUT)
	tween.tween_property(self, "scale", Vector2(1.0, 1.0), style_constants.ANIM_FAST)
